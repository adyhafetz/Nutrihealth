...
$stmt = $mysqli->prepare("UPDATE APPOINTMENT SET appointmentDetails = ?, appointmentDate = ?, appointmentTime = ? WHERE appointmentID = ? AND expertID = ?");
$stmt->bind_param("sssii", $details, $date, $time, $appointmentID, $expertID);
$stmt->execute();
